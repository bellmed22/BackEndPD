                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="servicios__item">
                                ...
                                <div class="servicios__item__text">                        
                                    <div class="servicios__item__descripcion">Start From IDR 1.000.000</div>
                                    <div class="masinfo">
                                        <a href="diseno.php">Leer más</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="servicios__item">
                        ...
                        <div class="servicios__item__text">                        
                            <div class="servicios__item__descripcion">Start From IDR 1.000.000</div>
                            <div class="masinfo">
                                <a href="ilustracion.php">Leer más</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="servicios__item">
                        ...
                        <div class="servicios__item__text">                        
                            <div class="servicios__item__descripcion">Start From IDR 1.000.000</div>
                            <div class="masinfo">
                                <a href="desarrollo.php">Leer más</a>
                            </div>
                        </div>
                    </div>
                </div>
